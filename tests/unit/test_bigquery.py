...
def test_bigquery_magic_default_connection_user_agent():
    ...
    assert client_info_arg.user_agent == f"ipython-{IPython.__version__} bigquery-magics/{bigquery_magics.__version__}"
...
def test_bigquery_magic_with_bqstorage_from_argument(monkeypatch):
    ...
    assert client_info.user_agent == f"ipython-{IPython.__version__} bigquery-magics/{bigquery_magics.__version__}"
